...
#include <loop_closure_transform/Descriptors.h>
#include <loop_closure_transform/KeyPoint3DVec.h>
#include <loop_closure_transform/KeyPointVec.h>
...
std::vector<cv::Point3f> keypoints3DFromROS(const loop_closure_transform::KeyPoint3DVec &msg);
void keypoints3DToROS(const std::vector<cv::Point3f> &kpts, loop_closure_transform::KeyPoint3DVec &msg);

std::vector<cv::KeyPoint> keypointsFromROS(const loop_closure_transform::KeyPointVec &msg);
void keypointsToROS(const std::vector<cv::KeyPoint> &kpts, loop_closure_transform::KeyPointVec &msg);
...
cv::Mat descriptorsFromROS(const loop_closure_transform::Descriptors &msg);
void descriptorsToROS(const cv::Mat &descriptors, loop_closure_transform::Descriptors &msg);
